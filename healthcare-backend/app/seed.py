...
async def seed_database():
    ...
    if await users_col.count_documents({}) == 0:
        users = [
            ...
            {"_id": "P001", "username": "patient", "hashed_password": hash_password("patient123"), "name": "Rahul Sharma", "role": "Patient", "avatar": "👤"},
        ]
    ...
    if await appointments_col.count_documents({}) == 0:
        appointments = [
            {"_id": "APT001", "patientId": "P001", "patientName": "Rahul Sharma",     "doctorName": "Dr. Rajesh Kumar",   "department": "Cardiology",    "date": "2026-04-18", "time": "09:00 AM", "status": "Scheduled",   "type": "Consultation", "notes": "BP monitoring, ECG review",         "createdAt": "2026-04-10T10:00:00"},
            {"_id": "APT002", "patientId": "P002", "patientName": "Priya Mehta",      "doctorName": "Dr. Priya Sharma",   "department": "Endocrinology", "date": "2026-04-18", "time": "10:30 AM", "status": "Scheduled",   "type": "Follow-up",    "notes": "Thyroid report review",             "createdAt": "2026-04-11T09:00:00"},
            {"_id": "APT003", "patientId": "P003", "patientName": "Arjun Patel",      "doctorName": "Dr. Amit Singh",     "department": "Orthopedics",   "date": "2026-04-17", "time": "02:00 PM", "status": "In Progress", "type": "Consultation", "notes": "Right knee pain, X-ray pending",    "createdAt": "2026-04-09T14:00:00"},
            {"_id": "APT004", "patientId": "P004", "patientName": "Sunita Verma",     "doctorName": "Dr. Kavita Negi",    "department": "Dermatology",   "date": "2026-04-16", "time": "11:00 AM", "status": "Completed",   "type": "Consultation", "notes": "Skin allergy treatment",            "createdAt": "2026-04-08T11:00:00"},
            {"_id": "APT005", "patientId": "P005", "patientName": "Vikram Singh",     "doctorName": "Dr. Rahul Gupta",    "department": "Surgery",       "date": "2026-04-19", "time": "08:00 AM", "status": "Scheduled",   "type": "Emergency",    "notes": "Appendix evaluation pre-surgery",  "createdAt": "2026-04-12T16:00:00"},
            {"_id": "APT006", "patientId": "P006", "patientName": "Kavita Joshi",     "doctorName": "Dr. Rajesh Kumar",   "department": "Cardiology",    "date": "2026-04-16", "time": "03:30 PM", "status": "Completed",   "type": "Follow-up",    "notes": "Post-angioplasty review",          "createdAt": "2026-04-08T15:00:00"},
            {"_id": "APT007", "patientId": "P007", "patientName": "Suresh Rawat",     "doctorName": "Dr. Sunil Verma",    "department": "Neurology",     "date": "2026-04-20", "time": "09:30 AM", "status": "Scheduled",   "type": "Consultation", "notes": "Migraine and dizziness",           "createdAt": "2026-04-13T10:00:00"},
            {"_id": "APT008", "patientId": "P008", "patientName": "Meena Joshi",      "doctorName": "Dr. Priya Sharma",   "department": "Endocrinology", "date": "2026-04-22", "time": "11:30 AM", "status": "Scheduled",   "type": "Follow-up",    "notes": "Diabetes management review",       "createdAt": "2026-04-14T09:30:00"},
            {"_id": "APT009", "patientId": "P009", "patientName": "Deepak Gupta",     "doctorName": "Dr. Amit Singh",     "department": "Orthopedics",   "date": "2026-04-15", "time": "04:00 PM", "status": "Cancelled",   "type": "Consultation", "notes": "Cancelled by patient",             "createdAt": "2026-04-07T12:00:00"},
            {"_id": "APT010", "patientId": "P010", "patientName": "Anita Chauhan",    "doctorName": "Dr. Meena Agarwal",  "department": "Pediatrics",    "date": "2026-04-18", "time": "01:00 PM", "status": "Scheduled",   "type": "Consultation", "notes": "Child vaccination schedule",        "createdAt": "2026-04-12T11:00:00"},
            {"_id": "APT011", "patientId": "P011", "patientName": "Ramesh Negi",      "doctorName": "Dr. Arun Mishra",    "department": "Pulmonology",   "date": "2026-04-18", "time": "11:00 AM", "status": "Scheduled",   "type": "Consultation", "notes": "Chronic cough and breathlessness",  "createdAt": "2026-04-13T14:00:00"},
            {"_id": "APT012", "patientId": "P012", "patientName": "Pooja Agarwal",    "doctorName": "Dr. Anita Malhotra", "department": "Gynecology",    "date": "2026-04-17", "time": "10:00 AM", "status": "Completed",   "type": "Consultation", "notes": "Routine antenatal check",           "createdAt": "2026-04-09T09:00:00"},
            {"_id": "APT013", "patientId": "P013", "patientName": "Rohit Malhotra",   "doctorName": "Dr. Sunil Verma",    "department": "Neurology",     "date": "2026-04-16", "time": "02:30 PM", "status": "Completed",   "type": "Emergency",    "notes": "Severe headache, stroke screening", "createdAt": "2026-04-08T13:00:00"},
            {"_id": "APT014", "patientId": "P014", "patientName": "Shalini Tripathi", "doctorName": "Dr. Kavita Negi",    "department": "Dermatology",   "date": "2026-04-21", "time": "12:00 PM", "status": "Scheduled",   "type": "Follow-up",    "notes": "Eczema treatment follow-up",        "createdAt": "2026-04-14T08:00:00"},
            {"_id": "APT015", "patientId": "P015", "patientName": "Karan Khanna",     "doctorName": "Dr. Ritu Joshi",     "department": "Ophthalmology", "date": "2026-04-19", "time": "10:00 AM", "status": "Scheduled",   "type": "Consultation", "notes": "Blurry vision, eye power check",    "createdAt": "2026-04-14T10:00:00"},
        ]
